...
public class NetheriteLeggings extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.NETHERITE_LEGGINGS,amount);
		...
		setItemFlags(meta);
		//Set name and lore
		setItemName(Utils.chat("&fNetherite Leggings &8[&5Tier: &7F&8]"));

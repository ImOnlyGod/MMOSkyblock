...
public class GoldenLeggings extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.GOLDEN_LEGGINGS,amount);
		...
		setItemFlags(meta);
		//Set name and lore
		setItemName(Utils.chat("&fGolden Leggings &8[&5Tier: &7F&8]"));
		meta.setDisplayName(getItemName());	
		meta.setCustomModelData(143);

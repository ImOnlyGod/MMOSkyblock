...
public class NetheriteHelmet extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.NETHERITE_HELMET,amount);
		...
		setItemFlags(meta);
		//Set name and lore
		setItemName(Utils.chat("&fNetherite Helmet &8[&5Tier: &7F&8]"));
		meta.setDisplayName(getItemName());	
		meta.setCustomModelData(134);

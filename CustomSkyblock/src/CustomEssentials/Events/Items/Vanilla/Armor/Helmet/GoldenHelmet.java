...
public class GoldenHelmet extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.GOLDEN_HELMET,amount);
		...
		setItemFlags(meta);
		//Set name and lore
		setItemName(Utils.chat("&fGolden Helmet &8[&5Tier: &7F&8]"));

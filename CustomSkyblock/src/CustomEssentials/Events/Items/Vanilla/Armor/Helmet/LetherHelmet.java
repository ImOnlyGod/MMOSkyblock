...
public class LetherHelmet extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.LEATHER_HELMET,amount);
		...
		setItemFlags(meta);
		//Set name and lore
		setItemName(Utils.chat("&fLeather Helmet &8[&5Tier: &7F&8]"));

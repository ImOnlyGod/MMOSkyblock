...
public class DiamondHelmet extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.DIAMOND_HELMET,amount);
		...
		setItemFlags(meta);
		//Set name and lore
		setItemName(Utils.chat("&fDiamond Helmet &8[&5Tier: &7F&8]"));

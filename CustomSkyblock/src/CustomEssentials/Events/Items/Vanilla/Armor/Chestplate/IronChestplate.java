...
public class IronChestplate extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.IRON_CHESTPLATE,amount);
		...
		setItemFlags(meta);
		//Set name and lore
		setItemName(Utils.chat("&fIron Chestplate &8[&5Tier: &7F&8]"));
		meta.setDisplayName(getItemName());	
		meta.setCustomModelData(137);

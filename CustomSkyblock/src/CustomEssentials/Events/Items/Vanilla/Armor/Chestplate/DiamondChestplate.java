...
public class DiamondChestplate extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.DIAMOND_CHESTPLATE,amount);
		...
		setItemFlags(meta);
		//Set name and lore
		setItemName(Utils.chat("&fDiamond Chestplate &8[&5Tier: &7F&8]"));

...
public class DiamondSword extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.DIAMOND_SWORD,amount);
		...
		setItemFlags(meta);
		//Set name and lore
		setItemName(Utils.chat("&fDiamond Sword &8[&5Tier: &7F&8]"));

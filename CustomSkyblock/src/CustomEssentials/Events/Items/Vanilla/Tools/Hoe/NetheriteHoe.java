...
public class NetheriteHoe extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.NETHERITE_HOE,amount);
		...
		setItemFlags(meta);
		//Set name and lore
		setItemName(Utils.chat("&fNetherite Hoe &8[&5Tier: &7F&8]"));

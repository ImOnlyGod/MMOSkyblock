...
public class NetheriteShovel extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.NETHERITE_SHOVEL,amount);
		...
		setItemFlags(meta);
		//Set name and lore
		setItemName(Utils.chat("&fNetherite Shovel &8[&5Tier: &7F&8]"));

...
public class StonePickaxe extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.STONE_PICKAXE,amount);
		...
		setItemFlags(meta);
		//Set name and lore
		setItemName(Utils.chat("&fStone Pickaxe &8[&5Tier: &7F&8]"));

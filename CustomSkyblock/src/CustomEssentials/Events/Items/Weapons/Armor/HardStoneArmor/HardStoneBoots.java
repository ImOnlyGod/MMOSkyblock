...
public class HardStoneBoots extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.CHAINMAIL_BOOTS,amount);
		...
		//Set name and lore
		setItemName(Utils.chat("&7Hard Stone Boots &8[&5Tier: &7F&8]"));

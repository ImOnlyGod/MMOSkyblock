...
public class HardStoneChestplate extends ItemsCore{
		
	public ItemStack createItem(int amount) {
		
		//Create the item
		ItemStack item = new ItemStack(Material.CHAINMAIL_CHESTPLATE,amount);
		...
		//Set name and lore
		setItemName(Utils.chat("&7Hard Stone Chestplate &8[&5Tier: &7F&8]"));
